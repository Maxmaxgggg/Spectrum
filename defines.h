...
#define CONST_MEM_SIZE				( 1 << 16 )										// Размер константной памяти видеокарты
#define WORD_SIZE					sizeof(quint64)									// Размер слова (под словом понимается тип данных quint64)
#define MAX_CONST_WORDS	            ( CONST_MEM_SIZE / WORD_SIZE )					// Максимальный размер массива в константной памяти видеокарты
///#define MAGIC_K					193												// Число строк матрицы, с которого необходимо отказываться от битовых масок
#define MAX_POSITIONS				33
#define MAX_BLOCKWORDS				32												// Максимальное число 64-битных слов, используемых для хранения одной строки
#define MAX_MASK_WORDS				32												// Максимальная длина битовой маски
